  ...
  return (
    ...
    <div className="bg-white shadow-md rounded-lg p-6 w-full md:w-full"> 
      <div className="flex items-center justify-between mb-4">
        ...
        <button className="bg-blue-50 hover:bg-gray-100 text-blue-500 border border-blue-500 font-bold py-1 px-8 rounded">Detail</button>
      ...
      <div className="flex items-center justify-between mb-2">
        <p className="text-gray-700 font-medium">Less: Authorized but not issued</p>
...
const CurrentBalance = () => {
  return (
    ...
    <div className="container mx-auto ">
      <h1 className="text-3xl font-bold text-center mb-8">Current Balance</h1>
      <p className="text-center mb-10">Lorem ipsum dolor sit amet consectetur. Adipiscing curabitur enim euismod libero aliquam</p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card
          title="On Ethereum"
          totalAuthorized="$69,929,452,093.66"
          less Authorized="-$494,8 93,954.06"
